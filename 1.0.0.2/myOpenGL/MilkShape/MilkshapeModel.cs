...
namespace Milkshape
{
    ...
    public class MilkshapeModel
    {
        ...
        public virtual void BindMaterial(int materialIndex, bool isForShades, int c)
        {
        ...
        public virtual void DrawModel(bool isForShades, int c)
        {
            // Draw by group
            for (int i = 0; i < model_data.numMeshes; i++)
            {
                BindMaterial(model_data.Meshes[i].materialIndex, isForShades, c);
